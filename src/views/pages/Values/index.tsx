...
import {  IValue } from "../../../lib";
import { useSelect } from "../../../helper";
import Loader  from 'react-loader-spinner';
import ReactNotification from 'react-notifications-component';
import { getValues, editValue, createValue, deleteValue } from "../../../React-Redux/Actions/values-action";
...
const Values: React.FC = () => {
  ...
  const [obj , setObj] = useState<IValue>({
    _id:'',
    arabic_header:'',
    english_header:'',
    arabic_sub_header:'',
  ...
  const {Value,Value_is_loading} = useSelect(state=> state.valueReducer)
  ...
  const handleSubmit = (e:any) =>{
    ...
    if(is_editing){
      dispatch(editValue({data:data , id:obj._id === undefined? '':obj._id}));
      toggleModal();
    }else{
      dispatch(createValue(data));
      toggleModal();
    }
  }
    ...
    return (
      <>
            ...
            >
              ...
              <div className="modal-body">
                <div className="py-3 text-center">
                  ...
                  <p>
                    Do you want to remove {obj.english_header} from Values ? to confirm please press delete otherwise close
                  </p>
                </div>
              </div>
              <div className="modal-footer">
                <Button className="btn-white" color="default" type="button"  onClick={()=>{dispatch(deleteValue(obj._id !== undefined? obj._id: '')); toggleNotificationModal()}}>
                  Delete
                </Button>
                <Button
        ...
        >
          <div className="modal-header">
            <h5 className="modal-title" id="exampleModalLabel">
              {obj?.english_header === ''? 'Create Value': 'Edit Value'}
            </h5>
            <button
              aria-label="Close"
              className="close"
          ...
          <Form role="form"onSubmit={(event) => handleSubmit(event)}>
            <FormGroup>
              <label className="form-control-label" htmlFor="example-text-input">Value Order</label>
      ...
      
        {
          Value_is_loading?
            <>
              <SimpleHeader name="Values" parentName="Values" />
                    ...
                    <Card>
                      <CardHeader className="border-0">
                        <div style={{display:'flex' , alignItems:'center', justifyContent:'space-between'}}>
                          <h3 className="mb-0">Values table</h3>
                          ...
                          <Button onClick={()=>{
                            ...
                            setObj(
                              ...
                              <span className="btn-inner--text">Create new Value</span>
                        ...
                        <div className={styles.default.cardsWrapper}>
                          {
                              ...
                              <CardBody>
                                    ...
                                    >
                                      <CardBody>
                                          <div className={styles.default.infoWrapper}>
                                            <span>Value English Header: {item.english_header}</span>
                                            <span>Value Arabic Header: {item.arabic_header}</span>
                                ...
                                <Card className="card-plain">
                                  ...
                                  >
                                    <CardBody>
                                        <div className={styles.default.infoWrapper}>
                                            <span>Value Sub English Header: {item.english_sub_header}</span>
                                            <span>Value Sub Arabic Header: {item.arabic_sub_header}</span>
                            ...
                            <Alert className={`alert-default ${styles.default.alert}`}>
                              <strong>Attention!</strong> There are no Values to show, please Create new one from the button in the top right corner
                            </Alert>
                          }
